...
class TownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post towns_url, params: { town: { beaches: @town.beaches, description: @town.description, image: @town.image, location: @town.location, name: @town.name } }, as: :json
    end
  ...
  test "should update town" do
    patch town_url(@town), params: { town: { beaches: @town.beaches, description: @town.description, image: @town.image, location: @town.location, name: @town.name } }, as: :json
    assert_response 200
  end
